...
const ErdDiagram = () => {
  const [nodes, edges, setNodes, setEdges, setConnection, addNode, dragPane] = useErdDiagramStore(state => [state.nodes, state.edges, state.setNodes, state.setEdges, state.setConnection, state.addNode, state.dragPane])

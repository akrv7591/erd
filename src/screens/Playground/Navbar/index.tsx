...
import IconButton from "@/screens/Playground/Navbar/IconButton.tsx";
...
export default function Navbar() {
  ...
  return (
    <Stack w={"100%"} py={"5px"} gap={"5px"} align={"center"}>
      {data.map(action => <IconButton key={action.value} disabled={disabled} data={action}/>)}
    </Stack>
  )
}
